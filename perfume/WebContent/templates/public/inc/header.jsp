					...
					<li><span>Xin chào, <%=userInfor.getFullname()%></span>
						<form method="post" action="<%=request.getContextPath()%>/logout"
							...
							<button type="submit" class="btn btn-link"
								style="padding: 0; color: red;">Đăng xuất</button>
						</form></li>
				</ul>
			</div>
		</div>
					...
					<li><span class="dropBox-btn">Đăng nhập <i
						...
						<div class="dropBox">
							<div class="box-section">
								...
								<form class="accounts-form clearfix" method="post"
 ...
 %>
			...
			<div class="main-nav-bar">
				<nav class="navbar-collapse collapse">
					<ul class="main-nav">
						<li><a href="<%=request.getContextPath()%>/home">Trang
								chủ</a></li>
						<li><a href="<%=request.getContextPath()%>/home">Thương
								hiệu</a>
							<ul>
								<%
								...
								%>
								<li><a
									href="<%=request.getContextPath()%>/cat?id=<%=cat.getId()%>"><%=cat.getCatPerfume()%></a>
									<%
