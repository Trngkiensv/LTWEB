...
<body>
	...
	%>
	<div class="alert alert-success" role="alert">Đăng ký thành công.
	...
	if (!"".equals(request.getParameter("msg"))) {
		...
		if ("ERROR".equals(msg)) {
	%>
	<div class="alert alert-success" role="alert">Sai tên đăng nhập
		hoặc mật khẩu. Vui lòng nhập lại</div>
	<%
	}
	}
	%>
	...
	%>
	<div class="alert alert-success" role="alert">Mật khẩu đã được
		đổi thành công. Vui lòng đăng nhập lại!</div>
	<%
	}
	%>
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post"
					...
					<span class="login100-form-title"> Vui lòng đăng nhập để
						tiếp tục </span>
					...
					<div class="text-center p-t-12">
						<span class="txt1"> Bạn chưa có tài khoản </span> <a class="txt2"
							href="<%=request.getContextPath()%>/signup"> Đăng ký </a>
					</div>
	...
	<!--===============================================================================================-->
	<script
		src="<%=request.getContextPath()%>/templates/public/auth/vendor/jquery/jquery-3.2.1.min.js"></script>
	<!--===============================================================================================-->
	<script
		src="<%=request.getContextPath()%>/templates/public/auth/vendor/bootstrap/js/popper.js"></script>
	<script
		src="<%=request.getContextPath()%>/templates/public/auth/vendor/bootstrap/js/bootstrap.min.js"></script>
	<!--===============================================================================================-->
	<script src="vendor/select2/select2.min.js"></script>
	<!--===============================================================================================-->
	<script
		src="<%=request.getContextPath()%>/templates/public/auth/vendor/tilt/tilt.jquery.min.js"></script>
	<script>
		$('.js-tilt').tilt({
			scale : 1.1
		})
	...
	<!--===============================================================================================-->
	<script
		src="<%=request.getContextPath()%>/templates/public/auth/js/main.js"></script>
